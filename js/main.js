...
(function () {
  ...
  var swiperDetail = new Swiper(document.querySelector('.js-swiper-detail'), swiperDetailOptions);
})();
"use strict";

(function () {
  console.log('head-menu.js'); // top menu animation

  var menuWrap = document.querySelector('.js-menu');
  var menuBtn = document.querySelector('.js-menu-btn');
  var menuBlock = document.querySelector('.js-menu-block');
  menuBtn.addEventListener("click", function () {
    menuWrap.classList.toggle('active');
    menuBtn.classList.toggle('active');
    slideToggle(menuBlock, 300);
  }, false);
  /* SLIDE UP */
...
(function () {
  ...
  var swiperMainSelector = document.querySelectorAll('.js-swiper-main');
  Array.prototype.forEach.call(swiperMainSelector, function (el, i) {
    var swiperMain = new Swiper(el, swiperMainOptions);
  });
})();
"use strict";
